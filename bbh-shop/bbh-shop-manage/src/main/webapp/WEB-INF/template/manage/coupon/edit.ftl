...
<title>${message("manage.coupon.edit")}</title>
...
<body>
	<div class="path">
		<a href="${base}/manage/common/index.do">${message("manage.path.index")}</a> &raquo; ${message("manage.coupon.edit")}
	</div>
	<form id="inputForm" action="update.do" method="post">
		<input type="hidden" name="id" value="${coupon.id}" />
		<ul id="tab" class="tab">
			<li>
				<input type="button" value="${message("manage.coupon.base")}" />
			</li>
			<li>
		...
		<div class="tabContent">
			<table class="input">
				...
				<tr>
					...
					<td colspan="2">
						<input type="text" name="priceExpression" class="text" value="${coupon.priceExpression}" maxlength="255" title="${message("manage.coupon.priceExpressionTitle")}" />
					</td>
				</tr>
				<tr>
					<th>

...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.do">${message("admin.path.index")}</a> &raquo; ${message("admin.refunds.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as refunds]
				<tr>
					...
					<td>
						<a href="view.do?id=${refunds.id}">[${message("admin.common.view")}]</a>
					</td>
				</tr>
			[/#list]
		</table>

 ...
 */
package com.bbh.shop.provider.manage.security;
...
import com.bbh.shop.provider.manage.common.Setting;
import com.bbh.shop.provider.manage.common.SettingUtils;
...
public class AuthenticationRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(org.apache.shiro.authc.AuthenticationToken token) {
		...
		if (!captchaService.isValid(Setting.CaptchaType.manageLogin, captchaId, captcha)) {
		...
		if (username != null && password != null) {
			...
			if (manage.getIsLocked()) {
				if (ArrayUtils.contains(setting.getAccountLockTypes(), Setting.AccountLockType.manage)) {

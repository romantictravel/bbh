...
<title>${message("manage.promotion.add")}</title>
...
<body>
	<div class="path">
		<a href="${base}/manage/common/index.do">${message("manage.path.index")}</a> &raquo; ${message("manage.promotion.add")}
	</div>
		...
		<div class="tabContent">
			<table class="input">
				...
				<tr>
					...
					<td colspan="2">
						<input type="text" name="priceExpression" class="text" maxlength="255" title="${message("manage.promotion.priceExpressionTitle")}" />
					</td>
				</tr>
				<tr>
					<th>
					...
					<td colspan="2">
						<input type="text" name="pointExpression" class="text" maxlength="255" title="${message("manage.promotion.pointExpressionTitle")}" />
					</td>
				</tr>
				<tr>
					<th>

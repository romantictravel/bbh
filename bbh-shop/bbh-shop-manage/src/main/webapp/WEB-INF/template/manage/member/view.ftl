...
<title>${message("manage.member.view")}</title>
...
<body>
	<div class="path">
		<a href="${base}/manage/common/index.do">${message("manage.path.index")}</a> &raquo; ${message("manage.member.view")}
	</div>
	<ul id="tab" class="tab">
		<li>
	...
	<table class="input tabContent">
		...
		<tr>
			...
			<td>
				...
				<a href="../deposit/list.do?memberId=${member.id}">[${message("manage.member.viewDeposit")}]</a>
			</td>
		</tr>
		<tr>
			<th>
		...
		<tr>
			<th>
				${message("manage.member.reviewCount")}:
			</th>
			<td>
				${member.reviews?size}
			</td>
		...
		<tr>
			<th>
				${message("manage.member.consultationCount")}:
			</th>
			<td>
		...
		<tr>
			<th>
				${message("manage.member.favoriteProductCount")}:
			</th>
			<td>

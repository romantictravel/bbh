...
<title>${message("manage.navigation.add")}</title>
...
<body>
	<div class="path">
		<a href="${base}/manage/common/index.do">${message("manage.path.index")}</a> &raquo; ${message("manage.navigation.add")}
	</div>
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					<select id="systemUrl">
						<option value="">------------</option>
						<option value="${base}/">${message("manage.navigation.home")}</option>
						<option value="${base}/product_category.do">${message("manage.navigation.productCategory")}</option>
						<option value="${base}/friend_link.do">${message("manage.navigation.friendLink")}</option>
						<option value="${base}/member/index.do">${message("manage.navigation.member")}</option>

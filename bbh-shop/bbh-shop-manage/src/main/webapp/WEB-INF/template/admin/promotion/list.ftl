...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.do">${message("admin.path.index")}</a> &raquo; ${message("admin.promotion.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as promotion]
				<tr>
					...
					<td>
						<a href="edit.do?id=${promotion.id}">[${message("admin.common.edit")}]</a>

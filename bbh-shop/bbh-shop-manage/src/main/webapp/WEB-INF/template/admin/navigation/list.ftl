...
<title>${message("admin.navigation.list")}</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.do">${message("admin.path.index")}</a> &raquo; ${message("admin.navigation.list")}
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list topNavigations as navigation]
				<tr>
					...
					<td>
						<a href="edit.do?id=${navigation.id}">[${message("admin.common.edit")}]</a>
					</td>
				</tr>
			[/#list]

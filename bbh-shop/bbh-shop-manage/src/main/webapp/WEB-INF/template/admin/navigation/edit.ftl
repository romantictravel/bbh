...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.do">${message("admin.path.index")}</a> &raquo; ${message("admin.navigation.edit")}
	</div>
			...
			<tr>
				...
				<td>
					<select id="systemUrl">
						...
						<option value="${base}/product_category.do"[#if navigation.url == base + "/product_category.do"] selected="selected"[/#if]>${message("admin.navigation.productCategory")}</option>
						<option value="${base}/friend_link.do"[#if navigation.url == base + "/friend_link.do"] selected="selected"[/#if]>${message("admin.navigation.friendLink")}</option>
						<option value="${base}/member/index.do"[#if navigation.url == base + "/member/index.do"] selected="selected"[/#if]>${message("admin.navigation.member")}</option>

...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.do">${message("admin.path.index")}</a> &raquo; ${message("admin.message.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
				...
				<tr>
					...
					<td>
						[#if !adminMessage.receiver??]
							<a href="${base}/admin/member/view.do?id=${adminMessage.sender.id}">
								${adminMessage.sender.username}
							</a>
						[#else]
							<a href="${base}/admin/member/view.do?id=${adminMessage.receiver.id}">
					...
					<td>
						<a href="view.do?id=${adminMessage.id}">[${message("admin.common.view")}]</a>
					</td>
				</tr>
			[/#list]
		</table>

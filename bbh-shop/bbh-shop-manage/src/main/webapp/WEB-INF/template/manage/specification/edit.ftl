...
<title>${message("manage.specification.edit")}</title>
...
<body>
	<div class="path">
		<a href="${base}/manage/common/index.do">${message("manage.path.index")}</a> &raquo; ${message("manage.specification.edit")}
	</div>
				...
				<tr class="specificationValueTr">
					...
					<td>
						[#if specificationValue.products?has_content]
							<span title="${message("manage.specification.deleteExistProductNotAllowed", specificationValue.name)}">[${message("manage.common.delete")}]</span>
						[#else]
							<a href="javascript:;" class="deleteSpecificationValue">[${message("manage.common.delete")}]</a>
						[/#if]
					</td>

...
<title>${message("admin.payment.list")}</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.do">${message("admin.path.index")}</a> &raquo; ${message("admin.payment.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as payment]
				<tr>
					...
					<td>
						<a href="view.do?id=${payment.id}">[${message("admin.common.view")}]</a>
					</td>
				</tr>
			[/#list]
		</table>

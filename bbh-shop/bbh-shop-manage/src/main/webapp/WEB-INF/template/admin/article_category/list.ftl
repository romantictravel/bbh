...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.do">${message("admin.path.index")}</a> &raquo; ${message("admin.articleCategory.list")}
	</div>
	<div class="bar">
		...
		[#list articleCategoryTree as articleCategory]
			<tr>
				...
				<td>
					...
					<a href="edit.do?id=${articleCategory.id}">[${message("admin.common.edit")}]</a>

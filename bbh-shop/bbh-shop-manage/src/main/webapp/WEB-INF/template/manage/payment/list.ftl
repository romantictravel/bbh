...
<title>${message("manage.payment.list")}</title>
...
<body>
	<div class="path">
		<a href="${base}/manage/common/index.do">${message("manage.path.index")}</a> &raquo; ${message("manage.payment.list")} <span>(${message("manage.page.total", page.total)})</span>
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as payment]
				<tr>
					...
					<td>
						<a href="view.do?id=${payment.id}">[${message("manage.common.view")}]</a>
					</td>
				</tr>
			[/#list]
		</table>

...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.do">${message("admin.path.index")}</a> &raquo; ${message("admin.message.view")}
	</div>
				...
				<tr>
					<th>
						[#if replyMessage.sender??]
							<a href="${base}/admin/member/view.do?id=${replyMessage.sender.id}">

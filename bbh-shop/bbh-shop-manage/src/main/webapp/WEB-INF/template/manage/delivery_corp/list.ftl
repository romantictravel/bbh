...
<title>${message("manage.deliveryCorp.list")}</title>
...
<body>
	<div class="path">
		<a href="${base}/manage/common/index.do">${message("manage.path.index")}</a> &raquo; ${message("manage.deliveryCorp.list")} <span>(${message("manage.page.total", page.total)})</span>
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as deliveryCorp]
				<tr>
					...
					<td>
						<a href="edit.do?id=${deliveryCorp.id}">[${message("manage.common.edit")}]</a>
					</td>
				</tr>
			[/#list]
		</table>

...
<title>${message("manage.print.shipping")}</title>
	...
	<div class="content">
		<table>
			...
			<tr class="separated">
				...
				<th colspan="2">
					${message("manage.common.createDate")}: ${order.createDate?string("yyyy-MM-dd")}
				</th>
				<th colspan="2">
					${message("manage.print.printDate")}: ${.now?string("yyyy-MM-dd")}
				</th>
			</tr>
			<tr>
				<td colspan="6">

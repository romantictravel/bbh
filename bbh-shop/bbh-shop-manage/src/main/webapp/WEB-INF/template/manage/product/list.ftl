...
<title>${message("manage.product.list")}</title>
...
$().ready(function() {
	...
	$moreButton.click(function() {
		$.dialog({
			title: "${message("manage.product.moreOption")}",
...
<body>
	<div class="path">
		<a href="${base}/manage/common/index.do">${message("manage.path.index")}</a> &raquo; ${message("manage.product.list")} <span>(${message("manage.page.total", page.total)})</span>
	</div>
			...
			<div class="buttonWrap">
				...
				<div class="menuWrap">
					<a href="javascript:;" id="filterSelect" class="button">
						${message("manage.product.filter")}<span class="arrow">&nbsp;</span>
					</a>
					<div class="popupMenu">
						<ul id="filterOption" class="check">
							<li>
								<a href="javascript:;" name="isMarketable" val="true"[#if isMarketable?? && isMarketable] class="checked"[/#if]>${message("manage.product.isMarketable")}</a>
							</li>
							<li>
								<a href="javascript:;" name="isMarketable" val="false"[#if isMarketable?? && !isMarketable] class="checked"[/#if]>${message("manage.product.notMarketable")}</a>
							</li>
							<li class="separator">
								<a href="javascript:;" name="isList" val="true"[#if isList?? && isList] class="checked"[/#if]>${message("manage.product.isList")}</a>
							</li>
							<li>
								<a href="javascript:;" name="isList" val="false"[#if isList?? && !isList] class="checked"[/#if]>${message("manage.product.notList")}</a>
							</li>
							<li class="separator">
								<a href="javascript:;" name="isTop" val="true"[#if isTop?? && isTop] class="checked"[/#if]>${message("manage.product.isTop")}</a>
							</li>
							<li>
								<a href="javascript:;" name="isTop" val="false"[#if isTop?? && !isTop] class="checked"[/#if]>${message("manage.product.notTop")}</a>
							</li>
							<li class="separator">
								<a href="javascript:;" name="isGift" val="true"[#if isGift?? && isGift] class="checked"[/#if]>${message("manage.product.isGift")}</a>
							</li>
							<li>
								<a href="javascript:;" name="isGift" val="false"[#if isGift?? && !isGift] class="checked"[/#if]>${message("manage.product.nonGift")}</a>
							</li>
							<li class="separator">
								<a href="javascript:;" name="isOutOfStock" val="false"[#if isOutOfStock?? && !isOutOfStock] class="checked"[/#if]>${message("manage.product.isStack")}</a>
							</li>
							<li>
								<a href="javascript:;" name="isOutOfStock" val="true"[#if isOutOfStock?? && isOutOfStock] class="checked"[/#if]>${message("manage.product.isOutOfStack")}</a>
							</li>
							<li class="separator">
								<a href="javascript:;" name="isStockAlert" val="false"[#if isStockAlert?? && !isStockAlert] class="checked"[/#if]>${message("manage.product.normalStore")}</a>
							</li>
							<li>
								<a href="javascript:;" name="isStockAlert" val="true"[#if isStockAlert?? && isStockAlert] class="checked"[/#if]>${message("manage.product.isStockAlert")}</a>
							</li>
						</ul>
					</div>
				</div>
				<a href="javascript:;" id="moreButton" class="button">${message("manage.product.moreOption")}</a>
				<div class="menuWrap">
				...
				<tr>
					...
					<td>
						<span title="${product.fullName}">
							...
							[#if product.isGift]
								<span class="gray">[${message("manage.product.gifts")}]</span>
							[/#if]
						</span>
					...
					<td>
						<a href="edit.do?id=${product.id}">[${message("manage.common.edit")}]</a>
						[#if product.isMarketable]
							<a href="${base}${product.path}" target="_blank">[${message("manage.common.view")}]</a>
						[#else]
							[${message("manage.product.notMarketable")}]
						[/#if]
					</td>
				</tr>
			[/#list]

...
<title>${message("manage.deliveryCorp.add")}</title>
...
<body>
	<div class="path">
		<a href="${base}/manage/common/index.do">${message("manage.path.index")}</a> &raquo; ${message("manage.deliveryCorp.add")}
	</div>
	<form id="inputForm" action="save.do" method="post">
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" id="code" name="code" class="text" maxlength="200" title="${message("manage.deliveryCorp.codeTitle")}" />
				</td>
			</tr>
			<tr>
				<th>

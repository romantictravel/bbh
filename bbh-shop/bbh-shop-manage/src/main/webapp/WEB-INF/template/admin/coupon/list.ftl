...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.do">${message("admin.path.index")}</a> &raquo; ${message("admin.coupon.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as coupon]
				<tr>
					...
					<td>
						<a href="build.do?id=${coupon.id}">[${message("admin.coupon.build")}]</a>
						<a href="edit.do?id=${coupon.id}">[${message("admin.common.edit")}]</a>
					</td>
				</tr>
			[/#list]
		</table>

...
<title>${message("manage.adPosition.list")}</title>
...
<body>
	<div class="path">
		<a href="${base}/manage/common/index.do">${message("manage.path.index")}</a> &raquo; ${message("manage.adPosition.list")} <span>(${message("manage.page.total", page.total)})</span>
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as adPosition]
				<tr>
					...
					<td>
						<a href="edit.do?id=${adPosition.id}">[${message("manage.common.edit")}]</a>
					</td>
				</tr>
			[/#list]
		</table>

...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.do">${message("admin.path.index")}</a> &raquo; ${message("admin.template.list")}
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list templates as template]
				<tr>
					...
					<td>
						<a href="edit.do?id=${template.id}">[${message("admin.common.edit")}]</a>
					</td>
				</tr>
			[/#list]
		</table>

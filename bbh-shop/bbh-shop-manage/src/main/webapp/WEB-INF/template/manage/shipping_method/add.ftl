...
<title>${message("manage.shippingMethod.add")}</title>
...
<body>
	<div class="path">
		<a href="${base}/manage/common/index.do">${message("manage.path.index")}</a> &raquo; ${message("manage.shippingMethod.add")}
	</div>
	<form id="inputForm" action="save.do" method="post">
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" name="firstWeight" class="text" maxlength="9" title="${message("manage.shippingMethod.weightTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="continueWeight" class="text" maxlength="9" title="${message("manage.shippingMethod.weightTitle")}" />
				</td>
			</tr>
			<tr>
				<th>

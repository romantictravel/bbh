...
<title>${message("manage.review.edit")}</title>
...
<body>
	<div class="path">
		<a href="${base}/manage/common/index.do">${message("manage.path.index")}</a> &raquo; ${message("manage.review.edit")}
	</div>
	<form id="inputForm" action="update.do" method="post">
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					[#if review.member??]
						<a href="../member/view.do?id=${review.member.id}">${review.member.username}</a>
					[#else]

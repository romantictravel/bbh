...
<title>${message("manage.adPosition.add")}</title>
...
<body>
	<div class="path">
		<a href="${base}/manage/common/index.do">${message("manage.path.index")}</a> &raquo; ${message("manage.adPosition.add")}
	</div>
	<form id="inputForm" action="save.do" method="post">
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" name="width" class="text" maxlength="9" title="${message("manage.adPosition.widthTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="height" class="text" maxlength="9" title="${message("manage.adPosition.heightTitle")}" />
				</td>
			</tr>
			<tr>
				<th>

...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.do">${message("admin.path.index")}</a> &raquo; ${message("admin.log.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as log]
				<tr>
					...
					<td>
						<a href="view.do?id=${log.id}">[${message("admin.common.view")}]</a>
					</td>
				</tr>
			[/#list]
		</table>

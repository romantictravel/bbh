...
<title>${message("manage.friendLink.add")}</title>
...
<body>
	<div class="path">
		<a href="${base}/manage/common/index.do">${message("manage.path.index")}</a> &raquo; ${message("manage.friendLink.add")}
	</div>
			...
			<tr>
				...
				<td>
					<span class="fieldSet">
						...
						<input type="button" id="browserButton" class="button" value="${message("manage.browser.select")}" disabled="disabled" />
					</span>
				</td>
			</tr>
			<tr>

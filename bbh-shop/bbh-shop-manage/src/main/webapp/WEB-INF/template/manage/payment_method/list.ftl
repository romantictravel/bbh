...
<title>${message("manage.paymentMethod.list")}</title>
...
<body>
	<div class="path">
		<a href="${base}/manage/common/index.do">${message("manage.path.index")}</a> &raquo; ${message("manage.paymentMethod.list")} <span>(${message("manage.page.total", page.total)})</span>
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as paymentMethod]
				<tr>
					...
					<td>
						<a href="edit.do?id=${paymentMethod.id}">[${message("manage.common.edit")}]</a>
					</td>
				</tr>
			[/#list]
		</table>

...
<title>${message("manage.productCategory.edit")}</title>
...
<body>
	<div class="path">
		<a href="${base}/manage/common/index.do">${message("manage.path.index")}</a> &raquo; ${message("manage.productCategory.edit")}
	</div>
			...
			<tr>
				...
				<td>
					<select name="parentId">
						<option value="">${message("manage.productCategory.root")}</option>

...
<title>${message("manage.coupon.add")}</title>
...
<body>
	<div class="path">
		<a href="${base}/manage/common/index.do">${message("manage.path.index")}</a> &raquo; ${message("manage.coupon.add")}
	</div>
		...
		<div class="tabContent">
			<table class="input">
				...
				<tr>
					...
					<td colspan="2">
						<input type="text" name="priceExpression" class="text" maxlength="255" title="${message("manage.coupon.priceExpressionTitle")}" />
					</td>
				</tr>
				<tr>
					<th>

...
<title>${message("manage.product.add")}</title>
...
<body>
	<div class="path">
		<a href="${base}/manage/common/index.do">${message("manage.path.index")}</a> &raquo; ${message("manage.product.add")}
	</div>
	<form id="inputForm" action="save.do" method="post" enctype="multipart/form-data">
		...
		<table class="input tabContent">
			...
			<tr>
				...
				<td>
					<input type="text" name="sn" class="text" maxlength="100" title="${message("manage.product.snTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<label>
						<input type="checkbox" id="isMemberPrice" name="isMemberPrice" value="true" />${message("manage.product.isMemberPrice")}
					</label>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text" name="cost" class="text" maxlength="16" title="${message("manage.product.costTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="marketPrice" class="text" maxlength="16" title="${message("manage.product.marketPriceTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<span class="fieldSet">
						<input type="text" name="image" class="text" maxlength="200" title="${message("manage.product.imageTitle")}" />
			...
			<tr>
				...
				<td>
					<input type="text" name="weight" class="text" maxlength="9" title="${message("manage.product.weightTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="stock" class="text" maxlength="9" title="${message("manage.product.stockTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" name="point" class="text" maxlength="9" title="${message("manage.product.pointTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" name="keyword" class="text" maxlength="200" title="${message("manage.product.keywordTitle")}" />
				</td>
			</tr>
			<tr>
				<th>

...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.do">${message("admin.path.index")}</a> &raquo; ${message("admin.productCategory.list")}
	</div>
	<div class="bar">
		...
		[#list productCategoryTree as productCategory]
			<tr>
				...
				<td>
					...
					<a href="edit.do?id=${productCategory.id}">[${message("admin.common.edit")}]</a>

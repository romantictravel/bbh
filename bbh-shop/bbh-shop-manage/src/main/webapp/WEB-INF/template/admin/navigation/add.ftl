...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.do">${message("admin.path.index")}</a> &raquo; ${message("admin.navigation.add")}
	</div>
			...
			<tr>
				...
				<td>
					<select id="systemUrl">
						...
						<option value="${base}/product_category.do">${message("admin.navigation.productCategory")}</option>
						<option value="${base}/friend_link.do">${message("admin.navigation.friendLink")}</option>
						<option value="${base}/member/index.do">${message("admin.navigation.member")}</option>

...
<title>${message("manage.template.list")}</title>
...
<body>
	<div class="path">
		<a href="${base}/manage/common/index.do">${message("manage.path.index")}</a> &raquo; ${message("manage.template.list")}
	</div>
			...
			<div class="buttonWrap">
				...
				<div class="menuWrap">
					...
					<div class="popupMenu">
						<ul id="typeOption">
							<li>
								<a href="javascript:;"[#if !type??] class="current"[/#if] val="">${message("manage.template.allType")}</a>
							</li>
		...
		<table id="listTable" class="list">
			...
			[#list templates as template]
				<tr>
					...
					<td>
						<a href="edit.do?id=${template.id}">[${message("manage.common.edit")}]</a>
					</td>
				</tr>
			[/#list]
		</table>

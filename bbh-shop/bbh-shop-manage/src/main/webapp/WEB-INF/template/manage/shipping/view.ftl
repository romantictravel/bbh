...
<title>${message("manage.shipping.view")}</title>
...
<body>
	<div class="path">
		<a href="${base}/manage/common/index.do">${message("manage.path.index")}</a> &raquo; ${message("manage.shipping.view")}
	</div>
	<ul id="tab" class="tab">
		<li>
			<input type="button" value="${message("manage.shipping.base")}" />
		</li>
		<li>
			<input type="button" value="${message("manage.shipping.shippingItem")}" />
		</li>
	</ul>

...
<title>${message("manage.setting.edit")}</title>
...
$().ready(function() {
	...
	$mailTest.click(function() {
		var $this = $(this);
		if ($this.val() == "${message("manage.setting.mailTest")}") {
			$this.val("${message("manage.setting.sendMail")}");
			$toMailWrap.show();
		} else {
			...
			$.ajax({
				...
				beforeSend: function() {
					if (valid($smtpFromMail) & valid($smtpHost) & valid($smtpPort) & valid($smtpUsername) & valid($toMail)) {
						$mailTestStatus.html('<span class="loadingIcon">&nbsp;<\/span>${message("manage.setting.sendMailLoading")}');
	...
	$.validator.addMethod("compareLength", 
		...
		"${message("manage.setting.compareLength")}"
	);
...
<body>
	<div class="path">
		<a href="${base}/manage/common/index.do">${message("manage.path.index")}</a> &raquo; ${message("manage.setting.edit")}
	</div>
	<form id="inputForm" action="update.do" method="post" enctype="multipart/form-data">
		<ul id="tab" class="tab">
			<li>
				<input type="button" value="${message("manage.setting.base")}" />
			</li>
			<li>
				<input type="button" value="${message("manage.setting.show")}" />
			</li>
			<li>
				<input type="button" value="${message("manage.setting.registerSecurity")}" />
			</li>
			<li>
				<input type="button" value="${message("manage.setting.mail")}" />
			</li>
			<li>
				<input type="button" value="${message("manage.setting.other")}" />
			</li>
		</ul>
			...
			<tr>
				...
				<td>
					<span class="fieldSet">
						...
						<a href="${setting.logo}" target="_blank">${message("manage.common.view")}</a>
					</span>
				</td>
			</tr>
			<tr>
				...
				<td>
					<input type="text" name="hotSearch" class="text" value="${setting.hotSearch}" maxlength="200" title="${message("manage.setting.hotSearchTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
		...
		<table class="input tabContent">
			<tr>
				<th>
					<span class="requiredField">*</span>${message("manage.setting.largeProductImage")}:
				</th>
				<td>
					<span class="fieldTitle">${message("manage.setting.width")}:</span>
					<input type="text" name="largeProductImageWidth" class="text" value="${setting.largeProductImageWidth}" maxlength="9" style="width: 50px;" title="${message("manage.setting.widthTitle")}" />
					<span class="fieldTitle">${message("manage.setting.height")}:</span>
					<input type="text" name="largeProductImageHeight" class="text" value="${setting.largeProductImageHeight}" maxlength="9" style="width: 50px;" title="${message("manage.setting.heightTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
					<span class="requiredField">*</span>${message("manage.setting.mediumProductImage")}:
				</th>
				<td>
					<span class="fieldTitle">${message("manage.setting.width")}:</span>
					<input type="text" name="mediumProductImageWidth" class="text" value="${setting.mediumProductImageWidth}" maxlength="9" style="width: 50px;" title="${message("manage.setting.widthTitle")}" />
					<span class="fieldTitle">${message("manage.setting.height")}:</span>
					<input type="text" name="mediumProductImageHeight" class="text" value="${setting.mediumProductImageHeight}" maxlength="9" style="width: 50px;" title="${message("manage.setting.heightTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
					<span class="requiredField">*</span>${message("manage.setting.thumbnailProductImage")}:
				</th>
				<td>
					<span class="fieldTitle">${message("manage.setting.width")}:</span>
					<input type="text" name="thumbnailProductImageWidth" class="text" value="${setting.thumbnailProductImageWidth}" maxlength="9" style="width: 50px;" title="${message("manage.setting.widthTitle")}" />
					<span class="fieldTitle">${message("manage.setting.height")}:</span>
					<input type="text" name="thumbnailProductImageHeight" class="text" value="${setting.thumbnailProductImageHeight}" maxlength="9" style="width: 50px;" title="${message("manage.setting.heightTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
					<span class="requiredField">*</span>${message("manage.setting.defaultLargeProductImage")}:
				</th>
				<td>
					<span class="fieldSet">
						<input type="text" name="defaultLargeProductImage" class="text" value="${setting.defaultLargeProductImage}" maxlength="200" />
						<input type="button" class="button browserButton" value="${message("manage.browser.select")}" />
						<a href="${setting.defaultLargeProductImage}" target="_blank">${message("manage.common.view")}</a>
					</span>
				</td>
			</tr>
			<tr>
				<th>
					<span class="requiredField">*</span>${message("manage.setting.defaultMediumProductImage")}:
				</th>
				<td>
					<span class="fieldSet">
						<input type="text" name="defaultMediumProductImage" class="text" value="${setting.defaultMediumProductImage}" maxlength="200" />
						<input type="button" class="button browserButton" value="${message("manage.browser.select")}" />
						<a href="${setting.defaultMediumProductImage}" target="_blank">${message("manage.common.view")}</a>
					</span>
				</td>
			</tr>
			<tr>
				<th>
					<span class="requiredField">*</span>${message("manage.setting.defaultThumbnailProductImage")}:
				</th>
				<td>
					<span class="fieldSet">
						<input type="text" name="defaultThumbnailProductImage" class="text" value="${setting.defaultThumbnailProductImage}" maxlength="200" />
						<input type="button" class="button browserButton" value="${message("manage.browser.select")}" />
						<a href="${setting.defaultThumbnailProductImage}" target="_blank">${message("manage.common.view")}</a>
					</span>
				</td>
			</tr>
			<tr>
				...
				<td>
					<input type="text" name="watermarkAlpha" class="text" value="${setting.watermarkAlpha}" maxlength="9" title="${message("manage.setting.watermarkAlphaTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<span class="fieldSet">
						...
						<a href="${base}${setting.watermarkImage}" target="_blank">${message("manage.common.view")}</a>
					</span>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<select name="priceScale">
						<option value="0"[#if setting.priceScale == 0] selected="selected"[/#if]>${message("manage.setting.priceScale0")}</option>
						<option value="1"[#if setting.priceScale == 1] selected="selected"[/#if]>${message("manage.setting.priceScale1")}</option>
						<option value="2"[#if setting.priceScale == 2] selected="selected"[/#if]>${message("manage.setting.priceScale2")}</option>
						<option value="3"[#if setting.priceScale == 3] selected="selected"[/#if]>${message("manage.setting.priceScale3")}</option>
					</select>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<input type="text" name="defaultMarketPriceScale" class="text" value="${setting.defaultMarketPriceScale}" maxlength="7" title="${message("manage.setting.defaultMarketPriceScaleTitle")}" />
				</td>
			</tr>
		</table>
		<table class="input tabContent">
			...
			<tr>
				...
				<td>
					<input type="text" name="disabledUsername" class="text" value="${setting.disabledUsername}" maxlength="200" title="${message("manage.setting.disabledUsernameTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" name="accountLockCount" class="text" value="${setting.accountLockCount}" maxlength="9" title="${message("manage.setting.accountLockCountTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="accountLockTime" class="text" value="${setting.accountLockTime}" maxlength="9" title="${message("manage.setting.accountLockTimeTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="safeKeyExpiryTime" class="text" value="${setting.safeKeyExpiryTime}" maxlength="9" title="${message("manage.setting.safeKeyExpiryTimeTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="uploadMaxSize" class="text" value="${setting.uploadMaxSize}" maxlength="9" title="${message("manage.setting.uploadMaxSizeTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="uploadImageExtension" class="text" value="${setting.uploadImageExtension}" maxlength="200" title="${message("manage.setting.uploadImageExtensionTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="uploadFlashExtension" class="text" value="${setting.uploadFlashExtension}" maxlength="200" title="${message("manage.setting.uploadFlashExtensionTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="uploadMediaExtension" class="text" value="${setting.uploadMediaExtension}" maxlength="200" title="${message("manage.setting.uploadMediaExtensionTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="uploadFileExtension" class="text" value="${setting.uploadFileExtension}" maxlength="200" title="${message("manage.setting.uploadFileExtensionTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
		...
		<table class="input tabContent">
			...
			<tr>
				...
				<td>
					<input type="text" id="smtpPort" name="smtpPort" class="text" value="${setting.smtpPort}" maxlength="9" title="${message("manage.setting.smtpPorteTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="password" id="smtpPassword" name="smtpPassword" class="text" maxlength="200" title="${message("manage.setting.smtpPasswordTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
					${message("manage.setting.mailTest")}:
				</th>
				<td>
					<span class="fieldSet">
						<span id="toMailWrap" class="hidden">
							${message("manage.setting.toMail")}: <br />
							<input type="text" id="toMail" name="toMail" class="text ignore" maxlength="200" />
						</span>
						<input type="button" id="mailTest" class="button" value="${message("manage.setting.mailTest")}" />
		...
		<table class="input tabContent">
			...
			<tr>
				...
				<td>
					<input type="text" name="defaultPointScale" class="text" value="${setting.defaultPointScale}" maxlength="7" title="${message("manage.setting.defaultPointScaleTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<label title="${message("manage.setting.isDevelopmentEnabledTitle")}">
			...
			<tr>
				...
				<td>
					<input type="checkbox" name="isTaxPriceEnabled" value="true" title="${message("manage.setting.taxRateTitle")}"[#if setting.isTaxPriceEnabled] checked="checked"[/#if] />

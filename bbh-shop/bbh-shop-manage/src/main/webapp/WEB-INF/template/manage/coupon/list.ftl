...
<title>${message("manage.coupon.list")}</title>
...
<body>
	<div class="path">
		<a href="${base}/manage/common/index.do">${message("manage.path.index")}</a> &raquo; ${message("manage.coupon.list")} <span>(${message("manage.page.total", page.total)})</span>
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as coupon]
				<tr>
					...
					<td>
						<a href="build.do?id=${coupon.id}">[${message("manage.coupon.build")}]</a>
						<a href="edit.do?id=${coupon.id}">[${message("manage.common.edit")}]</a>
					</td>
				</tr>
			[/#list]
		</table>

...
<title>${message("manage.returns.view")}</title>
...
<body>
	<div class="path">
		<a href="${base}/manage/common/index.do">${message("manage.path.index")}</a> &raquo; ${message("manage.returns.view")}
	</div>
	<ul id="tab" class="tab">
		<li>
			<input type="button" value="${message("manage.returns.base")}" />
		</li>
		<li>
			<input type="button" value="${message("manage.returns.returnsItem")}" />
		</li>
	</ul>

...
<title>${message("manage.template.edit")}</title>
...
<body>
	<div class="path">
		<a href="${base}/manage/common/index.do">${message("manage.path.index")}</a> &raquo; ${message("manage.template.edit")} [${template.name}]
	</div>

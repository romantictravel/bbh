...
<title>${message("manage.deliveryTemplate.edit")}</title>
...
<script type="text/javascript" src="${base}/resources/manage/js/jquery.event.drag.js"></script>
	...
	$inputForm.validate({
		...
		submitHandler: function(form) {
			if ($.trim($container.html()) == "") {
				$.message("warn", "${message("manage.deliveryTemplate.emptyNotAllow")}");
				return false;
			}
...
<body>
	<div class="path">
		<a href="${base}/manage/common/index.do">${message("manage.path.index")}</a> &raquo; ${message("manage.deliveryTemplate.edit")}
	</div>
	<form id="inputForm" action="update.do" method="post">
		...
		<table class="input">
			...
			<tr>
				<th>
					${message("manage.common.handle")}:
				</th>
				<td>
					<div class="menuWrap">
						<a href="javascript:;" id="addTag" class="button">${message("manage.deliveryTemplate.addTags")}</a>
						<div class="popupMenu">
							<ul id="tagOption">
								<li>
									<a href="javascript:;" val="[#noparse]${deliveryCenter.name}[/#noparse]">${message("manage.deliveryTemplate.deliveryCenterName")}</a>
								</li>
								<li>
									<a href="javascript:;" val="[#noparse]${deliveryCenter.contact}[/#noparse]">${message("manage.deliveryTemplate.deliveryCenterContact")}</a>
								</li>
								<li>
									<a href="javascript:;" val="[#noparse]${deliveryCenter.areaName}[/#noparse]">${message("manage.deliveryTemplate.deliveryCenterArea")}</a>
								</li>
								<li>
									<a href="javascript:;" val="[#noparse]${deliveryCenter.address}[/#noparse]">${message("manage.deliveryTemplate.deliveryCenterAddress")}</a>
								</li>
								<li>
									<a href="javascript:;" val="[#noparse]${deliveryCenter.zipCode}[/#noparse]">${message("manage.deliveryTemplate.deliveryCenterZipCode")}</a>
								</li>
								<li>
									<a href="javascript:;" val="[#noparse]${deliveryCenter.phone}[/#noparse]">${message("manage.deliveryTemplate.deliveryCenterPhone")}</a>
								</li>
								<li>
									<a href="javascript:;" val="[#noparse]${deliveryCenter.mobile}[/#noparse]">${message("manage.deliveryTemplate.deliveryCenterMobile")}</a>
								</li>
								<li>
									<a href="javascript:;" val="[#noparse]${order.consignee}[/#noparse]">${message("manage.deliveryTemplate.orderConsignee")}</a>
								</li>
								<li>
									<a href="javascript:;" val="[#noparse]${order.areaName}[/#noparse]">${message("manage.deliveryTemplate.orderAreaName")}</a>
								</li>
								<li>
									<a href="javascript:;" val="[#noparse]${order.address}[/#noparse]">${message("manage.deliveryTemplate.orderAddress")}</a>
								</li>
								<li>
									<a href="javascript:;" val="[#noparse]${order.zipCode}[/#noparse]">${message("manage.deliveryTemplate.orderZipCode")}</a>
								</li>
								<li>
									<a href="javascript:;" val="[#noparse]${order.phone}[/#noparse]">${message("manage.deliveryTemplate.orderPhone")}</a>
								</li>
								<li>
									<a href="javascript:;" val="[#noparse]${order.sn}[/#noparse]">${message("manage.deliveryTemplate.orderSn")}</a>
								</li>
								<li>
									<a href="javascript:;" val="[#noparse]${order.freight}[/#noparse]">${message("manage.deliveryTemplate.orderFreight")}</a>
								</li>
								<li>
									<a href="javascript:;" val="[#noparse]${order.fee}[/#noparse]">${message("manage.deliveryTemplate.orderFee")}</a>
								</li>
								<li>
									<a href="javascript:;" val="[#noparse]${order.amountPaid}[/#noparse]">${message("manage.deliveryTemplate.orderAmountPaid")}</a>
								</li>
								<li>
									<a href="javascript:;" val="[#noparse]${order.weight}[/#noparse]">${message("manage.deliveryTemplate.orderWeight")}</a>
								</li>
								<li>
									<a href="javascript:;" val="[#noparse]${order.quantity}[/#noparse]">${message("manage.deliveryTemplate.orderQuantity")}</a>
								</li>
								<li>
									<a href="javascript:;" val="[#noparse]${currency(order.amount, true)}[/#noparse]">${message("manage.deliveryTemplate.orderAmount")}</a>
								</li>
								<li>
									<a href="javascript:;" val="[#noparse]${order.memo}[/#noparse]">${message("manage.deliveryTemplate.orderMemo")}</a>
								</li>
								<li>
									<a href="javascript:;" val="[#noparse]${setting.siteName}[/#noparse]">${message("manage.deliveryTemplate.siteName")}</a>
								</li>
								<li>
									<a href="javascript:;" val="[#noparse]${setting.siteUrl}[/#noparse]">${message("manage.deliveryTemplate.siteUrl")}</a>
								</li>
								<li>
									<a href="javascript:;" val="[#noparse]${setting.address}[/#noparse]">${message("manage.deliveryTemplate.siteAddress")}</a>
								</li>
								<li>
									<a href="javascript:;" val="[#noparse]${setting.phone}[/#noparse]">${message("manage.deliveryTemplate.sitePhone")}</a>
								</li>
								<li>
									<a href="javascript:;" val="[#noparse]${setting.zipCode}[/#noparse]">${message("manage.deliveryTemplate.siteZipCode")}</a>
								</li>
								<li>
									<a href="javascript:;" val="[#noparse]${setting.email}[/#noparse]">${message("manage.deliveryTemplate.siteEmail")}</a>
								</li>
								<li>
									<a href="javascript:;" val="[#noparse]${.now?string('yyyy-MM-dd')}[/#noparse]">${message("manage.deliveryTemplate.now")}</a>
								</li>
							</ul>
						</div>
					</div>
					<a href="javascript:;" id="deleteTag" class="button">${message("manage.deliveryTemplate.deleteTags")}</a>
				</td>
			</tr>
			<tr>
				<th>

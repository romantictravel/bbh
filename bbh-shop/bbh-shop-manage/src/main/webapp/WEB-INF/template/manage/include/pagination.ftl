...
[#if totalPages > 1]
	<div class="pagination">
		...
		[/#if]
		<span class="pageSkip">
			${message("manage.page.totalPages", totalPages)} ${message("manage.page.pageNumber", '<input id="pageNumber" name="pageNumber" value="' + pageNumber + '" maxlength="9" onpaste="return false;" />')}<button type="submit">&nbsp;</button>
		</span>
	</div>
[/#if]
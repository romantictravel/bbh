...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.do">${message("admin.path.index")}</a> &raquo; ${message("admin.member.view")}
	</div>
	<ul id="tab" class="tab">
		<li>
	...
	<table class="input tabContent">
		...
		<tr>
			...
			<td>
				...
				<a href="../deposit/list.do?memberId=${member.id}">[${message("admin.member.viewDeposit")}]</a>
			</td>
		</tr>
		<tr>
			<th>

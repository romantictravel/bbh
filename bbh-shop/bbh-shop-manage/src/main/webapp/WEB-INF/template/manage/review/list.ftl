...
<title>${message("manage.review.list")}</title>
...
<body>
	<div class="path">
		<a href="${base}/manage/common/index.do">${message("manage.path.index")}</a> &raquo; ${message("manage.review.list")} <span>(${message("manage.page.total", page.total)})</span>
	</div>
			...
			<div class="buttonWrap">
				...
				<div class="menuWrap">
					<a href="javascript:;" id="typeSelect" class="button">
						${message("manage.review.type")}<span class="arrow">&nbsp;</span>
					</a>
					<div class="popupMenu">
						<ul id="typeOption">
							<li>
								<a href="javascript:;"[#if type == null] class="current"[/#if] val="">${message("manage.review.allType")}</a>
							</li>
			...
			[#list page.content as review]
				<tr>
					...
					<td>
						...
						[#else]
							${message("manage.review.anonymous")}
						[/#if]
					</td>
					<td>
					...
					<td>
						<a href="edit.do?id=${review.id}">[${message("manage.common.edit")}]</a>
						<a href="${base}${review.path}" target="_blank">[${message("manage.common.view")}]</a>
					</td>
				</tr>
			[/#list]
		</table>

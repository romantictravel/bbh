...
<title>${message("manage.print.delivery")}</title>
...
$().ready(function() {
	...
	$print.click(function() {
		if ($deliveryTemplate.val() == "") {
			$.message("warn", "${message("manage.print.deliveryTemplateRequired")}");
			return false;
		}
		if ($deliveryCenter.val() == "") {
			$.message("warn", "${message("manage.print.deliveryCenterRequired")}");
			return false;
		}
		window.print();
		return false;
...
<body>
	<div class="bar">
		<form id="deliveryForm" action="delivery.do" method="get">
			<input type="hidden" name="orderId" value="${order.id}" />
			<a href="javascript:;" id="print" class="button">${message("manage.print.print")}</a>
			${message("manage.print.deliveryTemplate")}:
			...
			${message("manage.print.deliveryCenter")}:
